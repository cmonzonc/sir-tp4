						...
						<div class="section">
							<div id="roboto" class="scrollspy">
								<div id="blockquote" class="section scrollspy">
									<h2 class="header">Person inserted</h2>
									<p>
										...
										<div class="row">
									       <table>
									            <tr>
									                ...
									                <tr>
									                		<td><c:out value="${insertedPerson.id}"/></td>
									                    <td><c:out value="${insertedPerson.name}"/></td>
									                    <td><c:out value="${insertedPerson.surname}"/></td>
									                    <td><c:out value="${insertedPerson.email}"/></td>
									                </tr>
